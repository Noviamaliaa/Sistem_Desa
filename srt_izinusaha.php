            ...
            <div class="box">
				...
				<br><br>	<style>
							...
							<body>
                                  ...
                                  $query = "SELECT * FROM tb_izinusaha"; // Query untuk menampilkan semua data wisata alam
                                  $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
                                  
                                  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                    echo "<tr>";
                                    echo "<td>".$data['no_suratush']."</td>";
                                    ...
                                    echo "<td><a href='update_dataizinusaha.php?no_suratush=".$data['no_suratush']."'>Edit</a></td>";
                                    echo "<td><a href='proses_hapusizinusaha.php?no_suratush=".$data['no_suratush']."'>Delete</a></td>";
                                    echo "<td><a href='print_suratusahapernama.php?no_suratush=".$data['no_suratush']."'>Print</a></td>";
                                    echo "</tr>";
                                  }
                                  ?>
                              </link>
                            ...
                            <br>
                            <a href="tambah_dataizinusaha.php" class="btn btn-primary">tambah data</a>
