            ...
            <div class="box">
				...
				<br><br>	<style>
                            ...
                            <body>  
                                  ...
                                  $query = "SELECT * FROM tb_suratkm"; // Query untuk menampilkan semua data wisata alam
                                  $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
                                  
                                  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                    echo "<tr>";
                                    echo "<td>".$data['no_suratkm']."</td>";
                                    echo "<td>".$data['nama']."</td>";
                                    echo "<td>".$data['binti_bin']."</td>";
                                    echo "<td>".$data['ttl']."</td>";
                                    echo "<td>".$data['jenis_kelamin']."</td>";
                                    echo "<td>".$data['agama']."</td>";
                                    echo "<td>".$data['alamat']."</td>";
                                    echo "<td>".$data['tanggal_kematian']."</td>";
                                    echo "<td><a href='update_datakematian.php?no_suratkm=".$data['no_suratkm']."'>Edit</a></td>";
                                    echo "<td><a href='proses_hapussuratkm.php?no_suratkm=".$data['no_suratkm']."'>Delete</a></td>";
                                    echo "<td><a href='print_suratkmpernama.php?no_suratkm=".$data['no_suratkm']."'>Print</a></td>"; 
                                    echo "</tr>";
                                  }
                                  ?>
                              </link>
