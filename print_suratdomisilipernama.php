...
<center><br>    <span class="style2">SURAT KETERANGAN DOMISILI <br><br>Nomor :  <?php echo $data['no_suratdomisili']; ?></span>
<br>  </center><table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody>
 ...
 <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="forms">      
    <tbody><tr><td>Nama       </td>          <td width="550"> : <?php echo  $data['nama'];?></td></tr>
        <tr><td>Tempat Tanggal Lahir       </td><td bgcolor=""> : <?php echo $data['ttl'];?></td></tr>
        <tr><td>Jenis Kelamin<br>        </td>        <td bgcolor=""> : <?php echo $data['jenis_kelamin'];?></td></tr>
        <tr><td>Pekerjaan <br>        </td>        <td bgcolor=""> : <?php echo $data['Pekerjaan'];?></td></tr>
        <tr><td>Nomor KTP <br></td>        <td>: <?php echo $data['no_ktp'];?></td></tr>
        ...
        <tr></tbody></table>
    <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody><tr><td>
        <p>Orang tersebut  betul-betul warga kami sesuai dengan keterangan dari RT/RW setempat dan sepengetahuan kami benar-benar berdomisili sesuai dengan alamat tersebut di atas.
        <p>Keterangan ini dibuat untuk  :  ======== <?php echo $data['perihal_surat'];?> ==============
