...
<body>
            ...
            <div class="box">
                <div class="col-12">
                   ...
                   <h2 class="intro-text text-center">UPDATE SURAT
                        <strong>KETERANGAN BERKELAKUAN BAIK</strong>
                    </h2>
                    <hr>
                </div>
 ...
 <?php
  ...
  ?>
							  <form method="post" action="proses_ubahskkb.php?no_suratskkb=<?php echo $no_suratskkb; ?>" enctype="multipart/form-data">
                                <table cellpadding="8">
                                    <tr>
                                    </form>
                                    <div class="form-group">
                                            <label>No SKKB</label>
                                            <input name="no_suratskkb" type="text" class="form-control" placeholder="no_suratskkb" value="<?php echo $data['no_suratskkb']; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Nama </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="no_nik" type="text" class="form-control" placeholder="no_nik" value="<?php echo $data['no_nik']; ?>" />
                                        </div>
                                         <div class="form-group">
