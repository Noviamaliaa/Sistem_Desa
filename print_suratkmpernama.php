...
<center><br>    <span class="style2">SURAT KETERANGAN KEMATIAN <br><br>Nomor :  <?php echo $data['no_suratkm']; ?></span>
<br>  </center><table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody>
 ...
 <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="forms">      
    <tbody><tr><td>Nama       </td>          <td width="550"> : <?php echo  $data['nama'];?></td></tr>
        <tr><td>Binti/bin       </td><td bgcolor=""> : <?php echo $data['binti_bin'];?></td></tr>
        <tr><td>Tempat Tanggal Lahir<br>        </td>        <td bgcolor=""> : <?php echo $data['ttl'];?></td></tr>
        <tr><td>Warga Negara <br>        </td>        <td bgcolor=""> : <?php echo $data['warga_negara'];?></td></tr>
        <tr><td>Agama <br></td>        <td>: <?php echo $data['agama'];?></td></tr>
        <tr><td>Alamat <br></td>        <td>: <?php echo $data['alamat'];?></td></tr>
        <tr></tbody></table>
    <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody><tr><td><p>Orang tersebut di atas betul betul warga kami, berdasarkan keterangan RT/RW setempat dan 
sepengetahuan kami  telah Meninggal Dunia karena  <?php echo $data['penyebab_kematian'];?>.
</tr></tbody></table>
 <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="forms">      
    <tbody><tr><td>Hari/Tanggal        </td>          <td width="550"> : <?php echo  $data['tanggal_kematian'];?></td></tr>
    <tr><td>Di<br>        </td><td bgcolor=""> : <?php echo $data['alamat'];?></td></tr>
    </tbody></table>
    <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody><tr><td><p>Demikian Keterangan ini kami buat dengan sebenarnya mengingat sumpah jabatan
...
<div>
    <div style="width:200px;float:right">
       <center>Tugumukti, <?php $tgl=date('d-m-Y'); echo $tgl; ?>
        ...
        <br><br>
      <br><br> <p><p> <p>H. ONDO SOLIHIN<br> </center>
    </div>
