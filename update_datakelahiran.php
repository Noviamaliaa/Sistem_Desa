...
<body>
            ...
            <div class="box">
                <div class="col-12">
                   ...
                   <h2 class="intro-text text-center">UPDATE SURAT
                        <strong>KETERANGAN KELAHIRAN</strong>
                    </h2>
                    <hr>
                </div>
 ...
 <?php
  ...
  ?>
							  <form method="post" action="proses_ubahkelahiran.php?no_suratkel=<?php echo $no_suratkel; ?>" enctype="multipart/form-data">
                                <table cellpadding="8">
                                    <tr>
                                    </form>
                                     <div class="form-group">
                                            <label>No Surat Kelahiran</label>
                                            <input name="no_suratkel" type="text" class="form-control" placeholder="no_suratkel" value="<?php echo $data['no_suratkel']; ?>" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Anak Ke-</label>
                                            <input name="anak_ke" type="text" class="form-control" placeholder="anak_ke" value="<?php echo $data['anak_ke']; ?>" />
                                        </div>
                                         <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="tempat_lahir" type="text" class="form-control" placeholder="tempat_lahir" value="<?php echo $data['tempat_lahir']; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Lahir</label>
                                            <input name="tanggal_lahir" type="date" class="form-control" placeholder="dd/mm/yyyy" value="<?php echo $data['tanggal_lahir']; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Ibu</label>
                                            <input name="nama_ibu" type="text" class="form-control" placeholder="nama_ibu" value="<?php echo $data['nama_ibu']; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Agama</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="pekerjaan_ibu" type="text" class="form-control" placeholder="pekerjaan_ibu" value="<?php echo $data['pekerjaan_ibu']; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Ayah</label>
                                            <input name="nama_ayah" type="text" class="form-control" placeholder="nama_ayah" value="<?php echo $data['nama_ayah']; ?>" />
                                        </div>
                                       <div class="form-group">
                                            <label>Agama</label>
                                            <select name = "agama" class="form-control" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="pekerjaan_ayah" type="text" class="form-control" placeholder="pekerjaan_ayah" value="<?php echo $data['pekerjaan_ayah']; ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
