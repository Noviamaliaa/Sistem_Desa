...
<center><br>    <span class="style2">SURAT KETERANGAN KELAKUAN BAIK <br><br>Nomor :  <?php echo $data['no_suratskkb']; ?></span>
<br>  </center><table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody>
 ...
 <table width="960" border="0" align="center" cellpadding="0" cellspacing="0" class="forms">      
    <tbody><tr><td>Nama       </td>          <td width="550"> : <?php echo  $data['nama'];?></td></tr>
        ...
        <tr><td>No. NIK <br>        </td>        <td bgcolor=""> : <?php echo $data['no_nik'];?></td></tr>
        <tr><td>Pendidikan <br></td>        <td>: <?php echo $data['pendidikan'];?></td></tr>
        <tr><td>Agama <br></td>        <td>: <?php echo $data['agama'];?></td></tr>
        <tr><td>Alamat      </td><td> : <?php echo $data['alamat'];?></td></tr>
        <tr></tbody></table>
    <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="forms"><tbody><tr><td><p>Bahwa Orang yang bersangkutan  benar-benar Penduduk   Desa Tugumukti Kecamatan    Cisarua    Kabupaten Bandung Barat dinyatakan berkelakuan baik serta tidak pernah melakukan tindak pidana atau terlibat dalam organisasi terlarang sesuai dengan keterangan dari RT/RW N0.Reg  02/11
     setempat dan sepengetahuan kami benar-benar berdomisili sesuai dengan alamat tersebut di atas.
     <p> Keterangan ini di buat untuk :   <?php echo $data['perihal_surat'];?>.
    <p>Demikian Keterangan dari kami, mohon untuk diketahui dan dilancarkan segala keperluannya, atas segala perhatiannya kami ucapkan terima kasih.
</tr></tbody></table>
<div>
    <div style="width:200px;float:right">
       <center>Tugumukti, <?php $tgl=date('d-m-Y'); echo $tgl; ?>
        ...
        <br><br><br>
      <br><br> <p><p> <p>H.ONDO SOLIHIN  </p></p></p></center>
    </div>
