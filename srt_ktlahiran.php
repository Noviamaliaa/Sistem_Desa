            ...
            <div class="box">
				...
				<br><br>	<style>
							...
							<body>  
                                  ...
                                  $query = "SELECT * FROM tb_kelahiran"; // Query untuk menampilkan semua data wisata alam
                                  $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
                                  
                                  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                    echo "<tr>";
                                    echo "<td>".$data['no_suratkel']."</td>";
                                    ...
                                    echo "<td><a href='update_datakelahiran.php?no_suratkel=".$data['no_suratkel']."'>Edit</a></td>";
                                    echo "<td><a href='proses_hapuskelahiran.php?no_suratkel=".$data['no_suratkel']."'>Delete</a></td>";
                                    echo "<td><a href='print_suratkelahiranpernama.php?no_suratkel=".$data['no_suratkel']."'>Print</a></td>";
                                    echo "</tr>";
                                  }
                                  ?>
                              </link>
                            ...
                            <br>
                            <a href="tambah_datakelahiran.php" class="btn btn-primary">tambah data</a>
