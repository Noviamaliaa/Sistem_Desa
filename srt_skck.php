            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">SURAT
                        <strong>KETERANGAN KELAKUAN BAIK</strong>
                    </h2>
                    <hr>
                </div>
                ...
                <br><br>    <style>
                            ...
                            <body>
                             <link rel="stylesheet" type="text/css" href="utk_table.css">
                                  ...
                                  <tr>
                                    <th>No Surat Keterangan Baik</th>
                                    <th> Nama </th>
                                    <th> Tempat Lahir </th>
                                    <th> TTL </th>
                                    <th> Jenis Kelamin </th>
                                  ...
                                  $query = "SELECT * FROM tb_skkb"; // Query untuk menampilkan semua data wisata alam
                                  $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
                                  
                                  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                                    echo "<tr>";
                                    echo "<td>".$data['no_suratskkb']."</td>";
                                    ...
                                    echo "<td><a href='update_dataskkb.php?no_suratskkb=".$data['no_suratskkb']."'>Edit</a></td>";
                                    echo "<td><a href='proses_hapusskkb.php?no_suratskkb=".$data['no_suratskkb']."'>Delete</a></td>";
                                    echo "<td><a href='print_suratskkbpernama.php?no_suratskkb=".$data['no_suratskkb']."'>Print</a></td>";
                                    echo "</tr>";
                                  }
                                  ?>
                              </link>
                            ...
                            <br>
                            <a href="tambah_dataskkb.php" class="btn btn-primary">tambah data</a>
